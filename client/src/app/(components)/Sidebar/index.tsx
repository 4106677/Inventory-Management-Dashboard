	...
	return (
		<Link href={href}>
			...
			hover:text-blue-500 hover:bg-blue-100 gap-3 transition-colors ${isActive ? "bg-blue-200 text-white" : ""}`}>
				<Icon className="w-6 h-7 !text-gray-700"/>
	...
	return (
		<div className={sidebarClassNames}>
			...
			<div
				...
				<Image src='https://s3-inventorymanagement-api.s3.eu-north-1.amazonaws.com/logo.png' alt='adstock-logo' width={50} height={50} className='rounded w-8' />
